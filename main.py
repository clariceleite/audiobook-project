...
for num in range(pages):
    ...
    if text:
        engine = pyttsx3.init() // Inicializa a fala.
        engine.say(text) // Manda dizer o texto extraído da página.
        engine.runAndWait() //Inicia o processo de fala aguardando até que todo o texto da página seja lido antes de ir para a próxima.
